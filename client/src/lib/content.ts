...
export const products: Product[] = [
  {
    ...
    grades: [
      { name: "Select / Clear", desc: "Minimal knots, straight grain, suitable for furniture and joinery applications." },
      { name: "No. 1 Common", desc: "Small tight knots permitted, suitable for general construction and furniture." },
