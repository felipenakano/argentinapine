...
export const enTranslations = {
  ...
  home: {
    ...
    heroSub: "An independent reference and sourcing guide for international buyers of Argentine pine — lumber, mouldings, panels, and more.",
    ...
    whyPoints: [
      ...
      { title: "Established Export Infrastructure", body: "Argentina's northeastern ports are well-equipped for container loading of lumber and processed wood products, with regular liner services to Asia, the Middle East, and the Pacific." },
      { title: "Broad Product Range", body: "From rough-sawn lumber and dressed boards to precision finger joint mouldings and laminated panels, Argentine mills offer a wide range of value-added products ready for export." },
    ],
  },
  products: {
    title: "Argentine Pine Products",
    subtitle: "Lumber, mouldings, panels, and finger joint products for international buyers.",
    intro: "Argentine pine mills produce a comprehensive range of processed timber products for export. Each product category below covers typical specifications, common applications, available grades, and how to submit an inquiry.",
  ...
  footer: {
    tagline: "An independent resource for international buyers of Argentine pine.",
    disclosure: "ArgentinaPine.com is operated by New Zealand Lumber Exports Limited, an independent pine sourcing specialist.",
...
export const viTranslations: Translations = {
  ...
  home: {
    ...
    heroSub: "Tài nguyên tham khảo và hướng dẫn thu mua độc lập dành cho người mua quốc tế về gỗ thông Argentina — gỗ xẻ, khuôn gỗ, tấm ván và nhiều sản phẩm khác.",
    heroCta: "Khám Phá Sản Phẩm",
    heroCtaSecondary: "Gửi Yêu Cầu",
    introTitle: "Tại Sao Chọn Gỗ Thông Argentina?",
    introBody: "Argentina là một trong những nước xuất khẩu gỗ thông trồng lớn nhất thế giới, sản xuất Pinus taeda và Pinus elliottii tại vùng Mesopotamia ở đông bắc Argentina. Các đồn điền thông tạo ra gỗ đồng đều, phân loại tốt, được người mua tại châu Á, Trung Đông và Thái Bình Dương đánh giá cao nhờ độ ổn định kích thước, khả năng gia công và giá cạnh tranh.",
    ...
    whyPoints: [
      ...
      { title: "Cơ Sở Hạ Tầng Xuất Khẩu Đã Được Thiết Lập", body: "Các cảng đông bắc Argentina được trang bị tốt để đóng container gỗ xẻ và các sản phẩm gỗ chế biến, với các tuyến vận chuyển thường xuyên đến châu Á, Trung Đông và Thái Bình Dương." },
      { title: "Đa Dạng Sản Phẩm", body: "Từ gỗ xẻ thô và ván đã bào đến khuôn gỗ ghép ngón chính xác và tấm ván ép, các xưởng Argentina cung cấp nhiều loại sản phẩm có giá trị gia tăng sẵn sàng để xuất khẩu." },
    ],
  },
  products: {
    title: "Sản Phẩm Gỗ Thông Argentina",
    subtitle: "Gỗ xẻ, khuôn gỗ, tấm ván và sản phẩm ghép ngón cho người mua quốc tế.",
...
export const filTranslations: Translations = {
  ...
  home: {
    ...
    heroSub: "Isang independiyenteng sanggunian at gabay sa pagkuha para sa mga internasyonal na mamimili ng pine mula Argentina — lumber, mouldings, panels, at marami pa.",
    heroCta: "Tuklasin ang Mga Produkto",
    heroCtaSecondary: "Magpadala ng Katanungan",
    introTitle: "Bakit Pine mula Argentina?",
    introBody: "Ang Argentina ay isa sa mga pinakamalaking exporter ng plantation pine sa mundo, na gumagawa ng Pinus taeda at Pinus elliottii sa rehiyon ng Mesopotamia sa hilagang-silangan ng Argentina. Ang mga plantation ng pine ay nagbubunga ng pare-pareho, mahusay na na-grade na kahoy na pinahahalagahan ng mga mamimili sa Asya, Gitnang Silangan, at Pasipiko.",
    ...
    whyPoints: [
      ...
      { title: "Naitatag na Export Infrastructure", body: "Ang mga daungan sa hilagang-silangan ng Argentina ay mahusay na nilagyan ng kagamitan para sa container loading ng lumber at mga processed na produktong kahoy." },
      { title: "Malawak na Hanay ng Produkto", body: "Mula sa rough-sawn lumber at dressed boards hanggang sa precision finger joint mouldings at laminated panels, nag-aalok ang mga mill sa Argentina ng malawak na hanay ng value-added na mga produkto." },
    ],
  },
  products: {
    title: "Mga Produktong Pine mula Argentina",
    subtitle: "Lumber, mouldings, panels, at finger joint products para sa mga internasyonal na mamimili.",
...
export const zhTranslations: Translations = {
  ...
  home: {
    ...
    heroSub: "面向国际买家的独立参考资源与采购指南——阿根廷松木材、线条、板材等产品一站式了解。",
    heroCta: "浏览产品",
    heroCtaSecondary: "发送询价",
    introTitle: "为何选择阿根廷松木？",
    introBody: "阿根廷是全球最大的人工林松木出口国之一，在阿根廷东北部的美索不达米亚地区生产火炬松（Pinus taeda）和湿地松（Pinus elliottii）。该国松木人工林出产的木材规格一致、分级良好，因其尺寸稳定性、加工性能和具有竞争力的价格，深受亚洲、中东和太平洋地区买家的青睐。",
    whyTitle: "为何从阿根廷采购",
    latestPosts: "最新文章",
    ...
    whyPoints: [
      ...
      { title: "成熟的出口基础设施", body: "阿根廷东北部港口具备完善的木材及木制品集装箱装载设施，定期开通前往亚洲、中东和太平洋地区的航线。" },
      { title: "产品种类丰富", body: "从粗锯材和刨光板到精密指接线条和层压板，阿根廷工厂提供多种增值产品，可直接出口。" },
    ],
  },
  products: {
    title: "阿根廷松木产品",
    subtitle: "面向国际买家的木材、线条、板材及指接产品。",
